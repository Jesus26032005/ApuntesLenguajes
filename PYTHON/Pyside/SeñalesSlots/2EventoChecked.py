...
class VentanaPrincipal(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Evento checked")
        ...
        # TODO: setCheckable(bool): Permite que el botón tenga dos estados (chequeado y deschequeado).
    ...
    def _checarEstado(self, estado):
        ...
        # estado: bool
        print(f"Botón {'chequeado' if estado else 'deschequeado'}!")
